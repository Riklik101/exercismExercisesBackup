...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    feeRate = ((spread / 100) + 1) * exchange_rate
    return get_number_of_bills(int(exchange_money(budget, feeRate)),denomination) * denomination

# for future reference, this may be the most sketchy code i've written to get tests to pass haha
